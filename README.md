...
3. Run `docker-compose run --rm node yarn install` to install frontend dependencies
4. Run `docker-compose up` (the logs will be displayed in the current shell)
5. Run database migrations : `docker-compose exec php bin/console doctrine:migrations:migrate`
